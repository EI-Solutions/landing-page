...
const TermsModal = ({ showing, setShowing }: TermModalProps) => {
  return (
    <Modal content="Terms" showing={showing} setShowing={setShowing}>
      <div className={`${styles.modal} text-black`}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Ei Solutions, Sem Sælands vei 1, 7034
              Trondheim.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            By email:{' '}
            <a href="mailto:gustav@eisolutions.no">gustav@eisolutions.no</a>
          </li>
        </ul>
      </div>
    </Modal>
