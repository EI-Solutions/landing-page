...
const CookieModal = ({ showing, setShowing }: CookieModalProps) => {



    return (
        <Modal content="Cookies" showing={showing} setShowing={setShowing}>
            <div className={`${styles.modal} text-black`}>
                ...
                <ul>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to Ei Solutions AS, Sem Sælands vei 1, 7034 Trondheim.</li>
                    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                    <li><strong>Website</strong> refers to Ei Solutions, accessible from <a href="https://www.eisolutions.no/" rel="external nofollow noopener" target="_blank">https://www.eisolutions.no/</a></li>
                ...
                <ul>
                    <li>By email: <a href="mailto:gustav@eisolutions.no">gustav@eisolutions.no</a></li>
                </ul>
            </div>
        </Modal>
    )
